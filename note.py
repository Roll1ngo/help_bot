...
from help_bot_classes import RequestShowHelp
...
def create_reqest_show_notes(*args):
    reqest_notes = RequestShowNotes()
    note_handler = Handler(reqest_notes)
    return note_handler.output_date(show_all_command(*args))
